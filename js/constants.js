...
export const STAT_KEYS = [Stat.Strength, Stat.Agility, Stat.Intellect, Stat.Charisma, Stat.Combat, Stat.Defense];
...
export const CHAOS_ESCALATION_TABLE = [
...
export const RANDOM_NPC_GENERATOR = [
...
export const LEGENDS_OF_THE_SILVER_FIST = [
...
export const ACTION_MOVIE_GLOSSARY = [
...
export const INITIAL_STATS = STAT_KEYS.map(stat => ({ stat, value: 0 }));
export const INITIAL_FILLABLE_SHEET_DATA = {
    name: "",
    archetypeName: ((_a = ARCHETYPES[0]) === null || _a === void 0 ? void 0 : _a.name) || "", // Default to first archetype or empty
    description: "",
